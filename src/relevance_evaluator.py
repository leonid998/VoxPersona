...
def build_relevance_prompt(question: str, report_description: str) -> str:
    ...
    Example:
        ...
        True
    """
    # Промпт оптимизирован для краткости и точности ответа
    # Требует ТОЛЬКО число без пояснений для упрощения парсинга
...
Инструкция:
Оцени в процентах (0-100%) насколько этот тип отчета релевантен для поиска ответа на вопрос.
0% - совершенно не релевантен
100% - идеально релевантен
