...
4. Если вопрос про дизайн/интерьер → приоритет Dizayn, Otchety_po_dizaynu
5. Если вопрос про мнения/отзывы → приоритет Intervyu
6. Если вопрос про инфраструктуру/зоны → приоритет Otchety_po_obsledovaniyu
7. Если вопрос общий/комплексный → приоритет Itogovye_otchety

ПРИМЕРЫ ПРАВИЛЬНОЙ ОЦЕНКИ:
- Вопрос "Какое освещение в номерах?" → Dizayn: 95, Otchety_po_dizaynu: 75, Intervyu: 30
- Вопрос "Что гости говорят о завтраке?" → Intervyu: 95, Itogovye_otchety: 50, Otchety_po_obsledovaniyu: 40
- Вопрос "Как улучшить клиентский сервис?" → Itogovye_otchety: 85, Intervyu: 70, Otchety_po_obsledovaniyu: 60"""
