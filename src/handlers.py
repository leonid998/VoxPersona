...
async def handle_expand_send(callback: CallbackQuery, app: Client):
    ...
    try:
        ...
        # Показываем список индексов
        # Сообщение с улучшенным вопросом уже показано пользователю
        text = (
            "**Выбор индекса для поиска**\n\n"
            "Выберите индекс, в котором искать ответ:"
        )
...
async def handle_query_send_as_is(callback: CallbackQuery, app: Client):
    ...
    # Текст с инструкцией выбора индекса
    text = (
        "**Выбор индекса для поиска**\n\n"
