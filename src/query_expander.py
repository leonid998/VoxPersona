...
def build_expansion_prompt(question: str, descry_content: str) -> str:
    ...
    return f"""Задача: Улучшить вопрос пользователя используя терминологию из описания БД.
...
Алгоритм улучшения:
1. Правильно и подробно разверни вопрос пользователя
...
5. Добавь уточняющие детали из описания

Требования к улучшенному вопросу:
- Сохранить смысл исходного вопроса
- Добавить терминологию из описания БД
