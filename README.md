...
- **Query Expansion** - Автоматическое улучшение вопросов пользователя для повышения качества поиска
...
### 🔍 Модуль улучшения вопросов (Query Expansion)

Автоматическое улучшение вопросов пользователя для повышения качества ответов системы быстрого/глубокого поиска.

#### Назначение
Модуль анализирует вопрос пользователя и автоматически обогащает его терминологией из описания базы данных, делая поиск более точным и релевантным.

#### Как это работает
1. Пользователь вводит вопрос (например: "расскажи про дизайн")
2. Система показывает улучшенный вариант с терминологией из БД
3. Пользователь выбирает: **"Отправить в поиск"** или **"Уточнить еще раз"**
4. Система выполняет поиск с улучшенным вопросом

#### Конфигурация
- **Файл описания БД**: `Description/descry.md` (создается вручную)
- **Модуль**: `src/query_expander.py`
- **Тесты**: `tests/test_query_expander.py` (18 unit-тестов, 100% coverage)
- **Автоактивация**: Модуль работает автоматически при наличии файла descry.md
- **Отключение**: Удалите или переименуйте файл descry.md

#### Защита от зацикливания
Максимум 3 попытки уточнения вопроса для предотвращения бесконечных циклов.
