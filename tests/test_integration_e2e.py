...
def mock_report_descriptions() -> Dict[str, str]:
    ...
    ВАЖНО: Имена отчетов ДОЛЖНЫ точно соответствовать INDEX_MAPPING из index_selector.py!
    Синхронизировано с INDEX_MAPPING (Code Review P0 исправление).
    ...
    return {
        ...
        # Itogovye_otchety (6 отчетов) - имена синхронизированы с INDEX_MAPPING
        ...
        # Otchety_po_obsledovaniyu (5 отчетов) - имена синхронизированы с INDEX_MAPPING
